...
const AdminCategories = () => {
  ...
  const handleSaveCategory = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingCategory) {
        await apiRequest(
          `/admin/api/v1/category/update/${editingCategory.id}`,
          "PATCH",
          formData,
        );
      } else {
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage main store categories and nested sub-categories.
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">
              {categoryList.filter((c) => c.parentCategory === null).length}
            </p>
          </div>
        </div>
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div className="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {categoryType === "main"
                      ? "Top-level category displayed in store navigation"
                      : "Nested sub-category assigned under a parent category"}
                  </p>
                </div>
                <button
                  type="button"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {categoryType === "sub" && (
                    <div className="md:col-span-2">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        Sub-category will be grouped under this main category
                      </p>
                    </div>
                  )}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder={
                        categoryType === "main"
                          ? "e.g. Men, Women, Electronics"
                          : "e.g. T-Shirts, Dresses, Laptops"
                      }
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Feature this category in the homepage slider or grid
                        </p>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Include in main navigation bar dropdowns
                        </p>
                      </div>
                      <input
                        type="checkbox"
