...
const AdminCancelledOrders = () => {
    ...
    const printBankDetails = (
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Bank Refund Details</title>
            ...
            <body>
                <div class="container">
                    ...
                    <h1>Bank Refund Details</h1>

                    <div class="subtitle">
                        Manual Refund Information
                    </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div className="mt-5 p-4 bg-yellow-50 border border-yellow-100 rounded-xl">
                                    ...
                                    <p className="text-xs text-yellow-700">
                                        This bank account is used for manual refund processing. Verify the account details before transferring the refund amount.
                                    </p>
                                    ...
                                    (request) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 max-w-[220px]">
                                                <p className="text-gray-600 truncate" title={ request.reason || "" } >{request.reason ||"No reason provided"}</p>
                                            </td>
                                            ...
                                            <td className="px-6 py-4">
                                                {request.refund ?.isRequired ? (
                                                    <div>
                                                        <p className="font-semibold text-gray-900">₹ {Number(request.refund.amount ||0).toFixed(2)}</p>
                                                        <p className="text-xs text-gray-400 uppercase mt-0.5">{request.refund.provider ||"-"}</p>
                                                    </div>
                                                ) : (
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${getRefundStatusColor(request.refund?.status)}`} >
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${getRequestStatusColor( request.status )}`}>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <button type="button" onClick={() =>setSelectedRequest(request)} className="text-brand text-sm font-semibold hover:underline" >
                                                    View
                                                </button>
                                            </td>
                                ...
                                filteredOrders.length ===
                                    ...
                                    <tr>
                                        <td colSpan={9} className="px-6 py-12 text-center" >
                                            <div className="flex flex-col items-center justify-center">
                                                <IoSearchOutline size={40} className="text-gray-300 mb-3" />
                                                <p className="text-gray-500 font-medium">
                                                    {searchTerm ||activeType !=="all"? "No requests found for your filters.": "No cancelled orders found."}
                                                </p>
