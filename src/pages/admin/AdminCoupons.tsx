...
const AdminCoupons = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isEditMode) {
        await apiRequest(
          `/admin/api/v1/coupon/update/${editId}`,
          "PATCH",
          payload,
        );
        ...
        await apiRequest("/admin/api/v1/coupon/add", "POST", payload);
  ...
  const expiredCoupons =
    coupons.filter((coupon: any) => coupon.status === "expired").length || 0;

  // Filter coupons by coupon code
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage promotional codes and active discounts.
          </p>
        </div>
        <button
          onClick={() => {
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Include Products (comma-separated SKUs)
                    </label>
                    <input
                      type="text"
                      name="productSku"
                      ...
                      onChange={handleChange}
                      placeholder="e.g. PRD-0001, PRD-0002"
                      className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-brand"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Exclude Products (comma-separated SKUs)
                    </label>
                    <input
                      type="text"
                      placeholder="e.g. PRD-0005"
                      name="excludeSku"
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Active coupon customers use kari shake. Inactive coupon use
                    nahi thai shake.
                  </p>
                </div>
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          {
            label: "Revenue Lost to Discounts",
            value: totalRevenueLost,
            color: "text-red-600",
          },
          {
