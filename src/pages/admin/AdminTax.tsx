    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Configure tax rules, GST slabs, and HSN code mappings.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-brand uppercase"
            />
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <input
              type="text"
              placeholder="e.g. NEHDO Fashion Pvt Ltd"
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              GST Tax Type (for same state)
            </label>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="text-sm text-blue-700">
                • <strong>Intra-State</strong> (Same state): CGST + SGST (split
                equally)
              </p>
              <p className="text-sm text-blue-700 mt-1">
                • <strong>Inter-State</strong> (Different state): IGST (full
                rate)
              </p>
              <p className="text-xs text-blue-500 mt-2">
                This is automatically determined based on customer's shipping
                address.
              </p>
            </div>
          </div>
          ...
          <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            <div>
              <p className="font-semibold text-gray-900 text-sm">
                Show Tax Breakup on Invoice
              </p>
              <p className="text-xs text-gray-500">
                Display CGST/SGST/IGST separately on invoice
              </p>
            </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                {
                  hsn: "6109",
                  desc: "T-Shirts (Cotton)",
                  gst: "5%",
                  cgst: "2.5%",
                  sgst: "2.5%",
                  igst: "5%",
                  applied: "T-Shirts, Polo Tees",
                },
                {
                  hsn: "6105",
                  desc: "Shirts (Knitted)",
                  ...
                  sgst: "2.5%",
                  igst: "5%",
                  applied: "Shirts, Formal",
                },
                {
                  hsn: "6204",
                  desc: "Women's Dresses",
                  gst: "12%",
                  cgst: "6%",
                  sgst: "6%",
                  igst: "12%",
                  applied: "Dresses, Skirts",
                },
                {
                  hsn: "6203",
                  desc: "Men's Suits & Jackets",
                  gst: "12%",
                  cgst: "6%",
                  sgst: "6%",
                  igst: "12%",
                  applied: "Jackets, Blazers",
                },
                {
                  hsn: "6404",
                  desc: "Footwear (above ₹1000)",
                  gst: "18%",
                  cgst: "9%",
                  sgst: "9%",
                  igst: "18%",
                  applied: "Shoes, Sneakers",
                },
                {
                  hsn: "7117",
                  desc: "Imitation Jewellery",
                  gst: "3%",
                  cgst: "1.5%",
                  sgst: "1.5%",
                  igst: "3%",
                ...
                <tr key={i} className="hover:bg-gray-50">
                  <td className="px-6 py-3 font-mono text-brand font-bold">
                    {slab.hsn}
                  </td>
                  ...
                  <td className="px-6 py-3 text-right">
                    <button className="text-brand text-sm font-semibold hover:underline mr-3">
                      Edit
                    </button>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-3">
          <div>
            <p className="font-semibold text-gray-900 text-sm">
              Tax-Free on Shipping
            </p>
            <p className="text-xs text-gray-500">
              Don't charge GST on shipping fees
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
        ...
        <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
          <div>
            <p className="font-semibold text-gray-900 text-sm">
              Exempt Exports (SEZ / Export Orders)
            </p>
            <p className="text-xs text-gray-500">
              Zero-rate tax on international orders
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input type="checkbox" className="sr-only peer" defaultChecked />
