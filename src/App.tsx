...
const AdminCancelledOrders = lazy(
  () => import("./pages/admin/AdminCancelledOrders"),
);
  ...
  return (
    <BrowserRouter basename="/nehdo">
      <Suspense fallback={<PageLoader />}>
          ...
          <Route element={<AdminProtectedRoute />}>
            <Route path="/admin" element={<AdminLayout />}>
              ...
              <Route
                path="*"
                element={
                  <div className="p-8 text-xl font-bold text-gray-400">
        ...
        <a
          href="https://wa.me/919714920969"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="fixed bottom-6 right-6 z-[9999] flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-green-600"
        >
